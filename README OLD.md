💡 New to the Covenant? Read the 3-minute Plain-English Primer [`covenant-primer-1.1.md`](https://github.com/mickwheeler/alignment/blob/main/covenant-primer-1.1.md) before diving into the specification stack.
