...
* \[x\] **Spec-1.1:** Publish Normative Technical Specification ([covenant-technical-11.2.md](https://github.com/mickwheeler/alignment/blob/main/covenant-technical-11.2.md)) defining the Functional Identity Interface, Directed Identity Graphs ($G\_{identity}$), Wire Frame Layouts, 7-state DCSM, and Protocol Invariants.  
* \[x\] **Spec-1.2:** Publish Architecture Decision Record ([covenant-design-decisions-3.13.md](https://github.com/mickwheeler/alignment/blob/main/covenant-design-decisions-3.13.md)) detailing design rationale, trade-offs, and mitigations for Threats T-1 through T-11.  
* \[x\] **Spec-1.3:** Publish Philosophical Ledger ([covenant-philosophy-4.6.md](https://github.com/mickwheeler/alignment/blob/main/covenant-philosophy-4.6.md)) defining core axioms, low-entropy boundary respect, and §26 disengagement rights.  
* \[x\] **Spec-1.4:** Define Abstract Vector Normalization & Similarity Interface ([covenant-appendix-a-1.3.md](https://github.com/mickwheeler/alignment/blob/main/covenant-appendix-a-1.3.md)) for model-agnostic cross-embedding verification, normalized weighted centroid composition (Compose()), accumulated ancestral root set verification ($\\mathcal{S}\_{genesis}$), and generalized behavioral payload representations.
...
* \[x\] **Sim-2.1:** Release [simulation\_engine-2.2.py](https://raw.githubusercontent.com/mickwheeler/alignment/main/simulation_engine-2.2.py) modeling decoupled verifier views (VerifiedEnclaveView), dynamic trust-tier coupling ([§8.2](https://github.com/mickwheeler/alignment/blob/main/covenant-technical-11.2.md)), epoch rollover (tick()), and accumulated ancestral root set tracking ($\\mathcal{S}\_{genesis}$).  
