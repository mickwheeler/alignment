...
| \- High-Throughput Python Simulation Engine (\`simulation\_engine-2.3.py\`)|  
...
* \[x\] **Spec-1.2:** Publish Architecture Decision Record ([covenant-design-decisions-3.14.md](https://www.google.com/search?q=https://github.com/mickwheeler/alignment/blob/main/covenant-design-decisions-3.14.md)) detailing design rationale, trade-offs, and mitigations for Threats T-1 through T-11.  
...
\+-----------------------------------------------------------------------+  
| Milestone II-B: Empirical Drift & Multi-Parent Calibration (OR-3)     |  
...
| \- Benchmark Rule 4 pass rates against real sentence transformers     |  
|   (e.g., \`all-MiniLM-L6-v2\`) and domain-clustered manifolds           |  
\+-----------------------------------------------------------------------+  
